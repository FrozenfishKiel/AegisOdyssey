...
#include "AOCameraMode_ThirdPerson.generated.h"

class UCurveVector;
/**
 * 
 */
struct FAOPenetrationAvoidanceFeeler;
UCLASS(Abstract, Blueprintable)
class UAOCameraMode_ThirdPerson : public UAOCameraMode
{
	GENERATED_BODY()

public:

	UAOCameraMode_ThirdPerson();
...
public:
	...
	TArray<FAOPenetrationAvoidanceFeeler> PenetrationAvoidanceFeelers;

	...
	FGameplayTag DesiredState) const
{
	...
	{
		UAOHeroComponent* HeroComp = GetOwner()->FindComponentByClass<UAOHeroComponent>();
		if (HeroComp) HeroComp->CheckDefaultInitialization();
		return true;
	}

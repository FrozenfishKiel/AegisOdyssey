...
#include "GF_AddWidgets.generated.h"
...
UCLASS()
class AEGISODYSSEY_API UGF_AddWidgets : public UGameFeatureAction_WordActionBase
{
	GENERATED_BODY()
public:

...
protected:
	...
	UFUNCTION()
	void OnParrySuccessEvent(FGameplayEventData Payload);

	UFUNCTION()
	void OnFullBlockSuccessEvent(FGameplayEventData Payload);

	UFUNCTION()
	void OnPartialBlockSuccessEvent(FGameplayEventData Payload);
private:
	...
	void ApplyEffectToSelf(TSubclassOf<UGameplayEffect> EffectClass) const;
...
private:
	...
	UPROPERTY()
	TObjectPtr<UAbilityTask_WaitGameplayEvent> WaitParrySuccessEventTask;
	UPROPERTY()
	TObjectPtr<UAbilityTask_WaitGameplayEvent> WaitFullBlockSuccessEventTask;
	UPROPERTY()
	TObjectPtr<UAbilityTask_WaitGameplayEvent> WaitPartialBlockSuccessEventTask;
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Block|Effects", meta = (AllowPrivateAccess = "true"))
	TSubclassOf<UGameplayEffect> BlockActiveEffectClass;

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Block|Effects", meta = (AllowPrivateAccess = "true"))
	TSubclassOf<UGameplayEffect> ParrySuccessEffectClass;

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Block|Effects", meta = (AllowPrivateAccess = "true"))
	TSubclassOf<UGameplayEffect> FullBlockSuccessEffectClass;

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Block|Effects", meta = (AllowPrivateAccess = "true"))
	TSubclassOf<UGameplayEffect> PartialBlockSuccessEffectClass;
	...
	FName StartSection;
	float StartTime = 0.f;
	FActiveGameplayEffectHandle BlockActiveEffectHandle;
